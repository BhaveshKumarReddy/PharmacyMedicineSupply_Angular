...
import { DaydateValidator, PastdateValidator, uniqueDateValidator } from 'src/app/Shared/past-day.validator';
  ...
  ngOnInit(){
    this.scheduleform=new FormGroup({
      scheduledate:new FormControl(this.date,[
        Validators.required,PastdateValidator(),DaydateValidator()
      ]),
    })
